...
def test_worker_command_builds_independent_streaming_camera():
    command=worker_command({"camera_id":"cam_exit_a","source":"1","counting_line_y":.55,"stream_fps":4,"inference_fps":4},"http://localhost:8000/api")
    ...
    assert command[command.index("--inference-fps")+1]=="4"
